...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SPHelper.registerContentObserver(SPHelper.SETTING_INFO, new SPHelper.DateChangeListener() {
            @Override
            public void onChange(boolean selfChange) {
                String settingInfo = SPHelper.getString(SPHelper.SETTING_INFO);
                Log.i("test","settingInfo："+settingInfo);
            }
        });
